(function (){
  ...
  module.exports = {
    ...
    catalogueAggregatorUrl:  util.format("http://shop-catalogue-aggregator%s:8080/camel", domain),
    tagsAggregatorUrl:       util.format("http://shop-catalogue-aggregator%s:8080/camel/catalogue/tags", domain),
